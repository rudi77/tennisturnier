...
internal static class Knowledge
{
    internal const string Text = """
        ...
        Der Ablauf:
        1. Anlegen. Pflicht ist der Name. Freiwillig: Datum, Uhrzeit des Starts, Ort, Disziplin (Einzel, Doppel oder noch offen), Modus (K.o. oder jeder gegen jeden), Satzformat. Vorgabe ist: Disziplin offen, K.o., zwei Gewinnsätze mit Match-Tiebreak statt des dritten Satzes.
        ...
        Drei Links, vom Server gebaut: Der Mitschau-Link (endet auf `?t=…`) ist für alle, zeigt Bracket, Tabelle und den laufenden Spielstand live ohne Neuladen und verlangt keine Anmeldung. Er lässt sich erneuern (unter „Teilen“ oder im Gespräch mit renew_viewer_link) — dann gilt der alte nicht mehr, und wer damit gerade zuschaut, sieht nur noch den Hinweis, nach dem neuen zu fragen; Eintragen-Link und Verwalterlink bleiben davon unberührt. Ablaufen tut er nie von selbst. Der Eintragen-Link (`?s=…`) ist für Mitspieler und Helfer und verlangt ebenfalls keine Anmeldung: Wer ihn hat, darf Spielstände live mitzählen und Ergebnisse eintragen oder zurücknehmen, aber sonst nichts am Turnier ändern. Der Verwalterlink (`?a=…`) ist geheim — wer ihn hat, darf an diesem Turnier alles. Er ist nicht zurückholbar, nur rotierbar; danach gilt der alte nicht mehr, und mit ihm auch der alte Eintragen-Link — der Mitschau-Link bleibt. Alle drei stehen unter „Teilen“ in der Kopfzeile. Konten gibt es nicht; eine Instanz kann eine Google-Anmeldung verlangen, dann folgen einem die eigenen Turniere auch auf ein anderes Gerät.

        Auf der Bühne steht immer genau ein Widget: Turnierkarte, Teilnehmerliste, Bracket, Tabelle, Turnierliste oder die Links. Ohne mich gehen dort: Turnier anlegen und seine Einstellungen ändern, Teilnehmer eintragen und streichen, im Doppel Teams aus einzelnen Spielern auslosen, auslosen und die Auslosung zurücknehmen, das Turnier starten, ein Match antippen und live zählen (Punkt oder Spiel je Seite, Rückgängig) oder das ganze Ergebnis mit Sätzen, Nichtantreten oder Aufgabe eintragen oder löschen, Turnier löschen, Links kopieren und teilen, den Mitschau-Link erneuern, über „Turniere“ in der Kopfzeile die eigene Liste öffnen.
        ...
        - Die Disziplin darf offen bleiben: Hat der Benutzer nicht gesagt, ob Einzel oder Doppel, steht sie auf offen, und die Namen lassen sich trotzdem schon eintragen — einzeln oder als Paar. Vor der Auslosung muss sie feststehen; steht sie noch auf offen, frag nach, statt zu raten.
